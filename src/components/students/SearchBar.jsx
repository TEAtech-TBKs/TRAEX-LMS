...
const onSearchHandler = (e) =>{
  ...
  return (
    <div>
        <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded shadow-md hover:shadow-lg'>
