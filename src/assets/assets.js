...
export const dummyTestimonial = [
    {
        name: 'Anita Adewale',
        role: 'frontend developer @ fiverr',
        image: assets.profile_img_1,
        rating: 5,
        feedback: 'I\'ve been using Imagify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.',
    },
    {
        name: 'Micheal Oyebade',
        role: 'mern stack developer @upwork',
...
export const dummyCourses = [
    {
        ...
        "courseTitle": "Introduction to JavaScript",
"courseDescription": "<h2>Master the Foundations of JavaScript</h2><p>JavaScript is the dynamic language behind modern, interactive websites. In this course, you'll explore essential concepts such as syntax, variables, data types, and control flow.</p><p>Designed for complete beginners, this course will guide you step-by-step through the fundamentals. By the end, you'll be confident building interactive interfaces and understanding how JavaScript powers real web experiences.</p><ul><li>Grasp core programming principles</li><li>Work with and manipulate the DOM</li><li>Build responsive and dynamic web features</li></ul>",        "coursePrice": 49.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
            {
    ...
    },
    {
        "_id": "675ac1512100b91a6d9b8b24",
        "courseTitle": "Advanced Python Programming",
"courseDescription": "<h2>Level Up Your Python Skills</h2><p>Ready to go beyond the basics? This advanced Python course empowers you to harness the full potential of Python with topics like decorators, generators, and context managers. Learn to write efficient, elegant code that solves real-world problems.</p><p>Perfect for those with foundational Python knowledge, this course will prepare you to build professional-grade applications and stand out as a skilled Python developer.</p><ul><li>Master advanced data structures for efficient coding</li><li>Implement object-oriented programming like a pro</li><li>Leverage popular Python libraries and frameworks</li></ul>",
        "coursePrice": 79.99,
        "isPublished": true,
        "discount": 15,
        "courseContent": [
    ...
    },
    {
        ...
        "courseTitle": "Cybersecurity Basics",
"courseDescription": "<h2>Master Cybersecurity Essentials</h2><p>In today’s digital world, protecting systems and networks is more important than ever. This course covers the core principles of cybersecurity, including threat analysis, ethical hacking, and secure coding practices.</p><p>By the end of the course, you’ll be able to identify vulnerabilities, strengthen defenses, and apply practical security measures to real-world scenarios.</p><ul><li>Understand key security protocols</li><li>Explore encryption and data protection techniques</li><li>Perform basic penetration testing confidently</li></ul>",
        "coursePrice": 69.99,
        "isPublished": true,
        "discount": 15,
        "courseContent": [
    ...
    },
    {
        ...
        "courseTitle": "Web Development Bootcamp",
"courseDescription": "<h2>Become a Full-Stack Web Developer</h2><p>Ready to become a full-stack web developer? This all-in-one bootcamp takes you from the fundamentals of HTML, CSS, and JavaScript to advanced backend technologies, equipping you with the skills employers are looking for.</p><p>Through hands-on projects, portfolio-building exercises, and real-world scenarios, you’ll gain the practical experience needed to excel in the tech industry.</p><ul><li>Master both front-end and back-end development</li><li>Create responsive, dynamic web applications</li><li>Work with databases and server-side programming</li></ul>",
        "coursePrice": 99.99,
        "isPublished": true,
        "discount": 25,
        "courseContent": [
